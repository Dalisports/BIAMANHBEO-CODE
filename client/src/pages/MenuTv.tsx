                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-[0.6vw] flex-wrap">
                          <p className="text-[2.4vw] font-black text-white leading-tight truncate">
                            {item.name}
                          </p>
                          {idx === 0 && (
                            <motion.span
          ...
          <AnimatePresence mode="wait">
            {currentItem && (
              <motion.div
                ...
                className="absolute inset-x-0 top-0 p-[1.5vw] bg-gradient-to-b from-black/95 via-black/70 to-transparent z-20"
              >
                <div className="flex items-start justify-between gap-[1vw]">
                  <motion.p
                    ...
                    className="font-black text-[3.7vw] leading-tight text-white truncate flex-1"
                  >
                    {currentItem.name}
                  </motion.p>
                  <motion.p
                    ...
                    transition={{ duration: 1.5, repeat: Infinity }}
                    className="text-yellow-400 font-black text-[3.0vw] whitespace-nowrap"
                  >
